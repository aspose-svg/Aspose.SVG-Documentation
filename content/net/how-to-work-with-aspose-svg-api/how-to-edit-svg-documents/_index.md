...
The  [`RootElement`](https://reference.aspose.com/svg/net/aspose.svg/svgdocument/rootelement/)  property of the  [SVGDocument](https://reference.aspose.com/svg/net/aspose.svg/svgdocument/)  class points to the root `<svg>` element of the document.  The following code snippet illustrates how you can create and add  `<g>` element as the first child in the SVG document.
...
We can specify element attributes and their values using the [SetAttribute `(name, value)`](https://reference.aspose.com/svg/net/aspose.svg.dom/element/setattribute/), [GetAttribute `(name)`](https://reference.aspose.com/svg/net/aspose.svg.dom/element/getattribute/), [HasAttribute `(name)`](https://reference.aspose.com/svg/net/aspose.svg.dom/element/hasattribute/), [RemoveAttribute `(name)`](https://reference.aspose.com/svg/net/aspose.svg.dom/element/removeattribute/) methods of the [Element](https://reference.aspose.com/svg/net/aspose.svg.dom/element/) class.
...
The basic SVG shapes can be created using the [CreateElementNS`(namespaceURI, qualifiedName)`](https://reference.aspose.com/svg/net/aspose.svg.dom/document/createelementns/)  method. The `qualifiedName` must contain the string tag name of the SVG graphic element.
...
The methods [CreateSVGPathSegMovetoAbs ( `x, y`)](https://reference.aspose.com/svg/net/aspose.svg/svgpathelement/createsvgpathsegmovetoabs/), [CreateSVGPathSegCurvetoQuadraticAbs (`x, y, x1, y1`)](https://reference.aspose.com/svg/net/aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticabs/) and [CreateSVGPathSegCurvetoQuadraticSmoothAbs (`x, y`)](https://reference.aspose.com/svg/net/aspose.svg/svgpathelement/createsvgpathsegcurvetoquadraticsmoothabs/) take parameters of path data commands **M, C**, and **T** as their own parameters. The [`PathSegList`](https://reference.aspose.com/svg/net/aspose.svg.paths/isvganimatedpathdata/pathseglist/) property of the SVGPathSegList type provides access to the content of **d** attribute, in the form of path segments list, that matches the SVG syntax (details are in the article [**SVG Path Data**](https://docs.aspose.com/svg/net/drawing-basics/svg-path-data/)).
...
You can use such itemised and thorough code in terms of the DOM, programming, working with the document, and navigating the file. Using the [SetAttribute()](https://reference.aspose.com/svg/net/aspose.svg.dom/element/setattribute/) method, you can write the code on a single line for the SVG path data **d** setting.
