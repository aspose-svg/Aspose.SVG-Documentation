...
<svg viewbox="-100 0 800 200" xmlns="http://www.w3.org/2000/svg">
    ...
    <ellipse cx="95" cy="90" rx="75" ry="55" fill="#20B2AA" filter="url(#offset)" />
...
<svg viewbox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
  ...
  <use xlink:href="#park" filter="url(#filter40)" x="10" y="20" />
  <text x="10" y="15">value = "40"</text>
  <use xlink:href="#park" filter="url(#filter140)" x="355" y="20" />
  <text x="355" y="15">value = "140"</text>
  <use xlink:href="#park" filter="url(#filter240)" x="10" y="285" />
  <text x="10" y="280">value = "240"</text>
  <use xlink:href="#park" filter="url(#filter320)" x="355" y="285" />
  <text x="355" y="280">value = "320"</text>
</svg>
...
<svg viewbox="-100 0 800 300" xmlns="http://www.w3.org/2000/svg">
    <defs>
        <radialGradient id="myRG1" cx="0.5" cy="0.5" r="0.8" fx="25%" fy="25%" spreadMethod="pad">
            <stop offset="0%" stop-color="BISQUE" />
            <stop offset="30%" stop-color="SILVER" />
            <stop offset="60%" stop-color="BISQUE" />
            <stop offset="90%" stop-color="GREY" />
